...
map.prop(
  ...
  crate({ id: 'd1-prop-dyn-arrival-a', at: [-61, 0, 129], dynamic: true }),
  crate({ id: 'd1-prop-dyn-arrival-b', at: [-59.8, 0, 128], dynamic: true }),
  crate({ id: 'd1-prop-dyn-market-a', at: [-24, 0, 104], dynamic: true }),
  crate({ id: 'd1-prop-dyn-market-b', at: [-16, 0, 89], dynamic: true }),
  crate({ id: 'd1-prop-dyn-market-c', at: [2, 0, 96], dynamic: true }),
  crate({ id: 'd1-prop-dyn-depot-a', at: [52, 0, 25], dynamic: true }),
  crate({ id: 'd1-prop-dyn-depot-b', at: [55, 0, 11], dynamic: true }),
  crate({ id: 'd1-prop-dyn-depot-c', at: [64, 0, 17], dynamic: true }),
  crate({ id: 'd1-prop-dyn-depot-d', at: [70, 0, 8], dynamic: true }),
  crate({ id: 'd1-prop-dyn-canal-a', at: [47, 0, -25], dynamic: true }),
  crate({ id: 'd1-prop-dyn-canal-b', at: [33, 0, -27], dynamic: true }),
  crate({ id: 'd1-prop-dyn-canal-c', at: [20, 0, -24], dynamic: true }),
  crate({ id: 'd1-prop-dyn-pump-a', at: [-48, 0, -32], dynamic: true }),
  crate({ id: 'd1-prop-dyn-radio-a', at: [-12, 0, 34], dynamic: true }),
  crate({ id: 'd1-prop-dyn-radio-b', at: [10, 0, 51], dynamic: true }),
  crate({ id: 'd1-prop-dyn-radio-c', at: [18, 0, 41], dynamic: true }),
);
