...
export const DemoLevel: LevelDefinition = {
  ...
  weaponPickups: [
    ...
    { id: 'pickup-revolver', weaponId: 'revolver', position: [-3.8, 0.35, 8.35] },
    ...
    { id: 'pickup-grenade-2', weaponId: 'grenade', position: [9.2, 0.35, 8.4] },
    { id: 'pickup-grenade-3', weaponId: 'grenade', position: [9.7, 0.35, 8.4] },
  ],
  ammoPickups: [
    { id: 'ammo-revolver-demo', ammoId: 'revolver', position: [-3.8, 0.35, 6.9] },
    { id: 'ammo-pistol-demo', ammoId: 'pistol', position: [-2.8, 0.35, 6.9] },
    { id: 'ammo-smg-demo', ammoId: 'smg', position: [-0.8, 0.35, 6.9] },
    { id: 'ammo-ar3-demo', ammoId: 'ar3', position: [1.2, 0.35, 6.9] },
    { id: 'ammo-energyball-demo', ammoId: 'energyBall', position: [1.7, 0.35, 6.9] },
    { id: 'ammo-crossbow-demo', ammoId: 'crossbow', position: [2.3, 0.35, 6.9] },
    { id: 'ammo-shotgun-demo', ammoId: 'shotgun', position: [5.4, 0.35, 6.9] },
    { id: 'ammo-rpg-demo', ammoId: 'rpg', position: [7.2, 0.35, 6.9] },
    { id: 'ammo-grenade-demo', ammoId: 'grenade', position: [8.7, 0.35, 6.9] },
  ],
  triggers: [
    {
      id: 'intro-trigger',
