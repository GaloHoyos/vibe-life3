...
export const StriderTestLevel: LevelDefinition = {
  ...
  weaponPickups: [
    ...
    { id: "pickup-rpg-st", weaponId: "rpg", position: [3, 2, 22] },
    { id: "pickup-grenade-st-1", weaponId: "grenade", position: [4.1, 2, 22] },
    { id: "pickup-grenade-st-2", weaponId: "grenade", position: [5.2, 2, 22] },
    { id: "pickup-grenade-st-3", weaponId: "grenade", position: [6.3, 2, 22] },
    { id: "pickup-grenade-st-4", weaponId: "grenade", position: [7.4, 2, 22] },
    { id: "pickup-grenade-st-5", weaponId: "grenade", position: [8.5, 2, 22] },
  ],
  ammoPickups: [
    { id: "ammo-ar3-st", ammoId: "ar3", position: [-4.5, 2, 20.6] },
    { id: "ammo-smg-st", ammoId: "smg", position: [-2, 2, 20.6] },
    { id: "ammo-shotgun-st", ammoId: "shotgun", position: [0.5, 2, 20.6] },
    { id: "ammo-rpg-st", ammoId: "rpg", position: [3, 2, 20.6] },
    { id: "ammo-grenade-st", ammoId: "grenade", position: [4.1, 2, 20.6] },
  ],
  triggers: [],
};
