...
export const EntityCatalog: Record<EntityClassId, EntityIODescriptor> = {
  ...
  npc: {
    outputs: [
      ...
      { id: 'OnBlobPoseReached', label: 'Blob: pose alcanzada' },
      { id: 'OnBlobSplit', label: 'Blob: dividido' },
      { id: 'OnBlobMerged', label: 'Blob: fusionado' },
      { id: 'OnBlobCommandFailed', label: 'Blob: comando fallido' },
    ],
    inputs: [
      ...
      { id: 'Teleport', label: 'Teletransportar', param: 'targetName' },
      { id: 'SetBlobPose', label: 'Blob: adoptar pose', param: 'string' },
      { id: 'ResetBlobPose', label: 'Blob: restaurar pose' },
      { id: 'SplitBlob', label: 'Blob: dividir', param: 'number' },
      { id: 'MergeBlob', label: 'Blob: fusionar' },
      { id: 'Kill', label: 'Matar' },
    ],
  },
  sequence: {
