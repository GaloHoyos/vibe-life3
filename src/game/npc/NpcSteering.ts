...
export interface SteeringNeighbor {
  position: Vector3;
  /** Radio físico aproximado para calcular cuándo separarse. */
  radius: number;
}
 ...
 * apilamiento contra otros NPCs (separation) y rodeando obstáculos
 * estáticos cercanos por raycast frontal. No reemplaza pathfinding —
 * sirve para los últimos 5-15m antes del target. Para rodear edificios
