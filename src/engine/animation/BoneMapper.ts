...
const aliases: Record<NormalizedBoneName, string[]> = {
  ...
  leftHand: ['LeftHand', 'Hand.L', 'mixamorigLeftHand', 'L_Hand', 'Bip01_L_Hand', 'hand_l', 'leftHand'],
  ...
  rightHand: ['RightHand', 'Hand.R', 'mixamorigRightHand', 'R_Hand', 'Bip01_R_Hand', 'hand_r', 'rightHand'],
